...
export default function Products() {
  ...
  useEffect(() => {
    axios
      .get("https://my-backend-api-usbu.onrender.com/view-products/frontend")
      .then((res) => {
  ...
  const handleAddToWishlist = async (e, product_id) => {
    ...
    try {
      const res = await axios.post("https://my-backend-api-usbu.onrender.com/add-wishlist", {
        user_id,
        product_id,
      });
              ...
              <div key={p._id} className="card">
                ...
                <Link to={`/product-detail?_id=${p._id}`}>
                  <div
                    className="img"
                    style={{
                      backgroundImage: `url(https://my-backend-api-usbu.onrender.com/uploads/${p.image})`,
                    }}
                  >
