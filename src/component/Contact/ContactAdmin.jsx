...
function Contact() {
    ...
    const contactview = async () => {
        try {
            const ApiUrl = 'http://localhost:8080/view-contact';
        ...
        try {
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    await axios.post('http://localhost:8080/delete-contact', { _id: user_Id });
                        ...
                        <div style={{ lineHeight: 1.6, color: '#333' }}>
                            ...
                            {selectedContact.image && (
                                <div style={{ marginTop: '20px' }}>
                                    ...
                                    <br />
                                    <img
                                        src={`http://localhost:8080/uploads/${selectedContact.image}`}
                                        alt="User"
                                        style={{
                                            width: '180px',
                                            height: 'auto',
