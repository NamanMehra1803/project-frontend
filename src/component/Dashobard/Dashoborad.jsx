...
function Dashboard() {
  ...
  const dashboardview = async () => {
    try {
      const response = await axios.post('http://localhost:8080/userViewdashboard');
  ...
  const ProductView = async () => {
    try {
      const response = await axios.post('http://localhost:8080/productViewdashboard');
  ...
  const CategoryView = async () => {
    try {
      const response = await axios.post('http://localhost:8080/categoryViewdashboard');
