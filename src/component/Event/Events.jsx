    ...
    const columns = useMemo(
        () => [
            ...
            },
            {
                ...
                header: 'Event Date',
                accessorFn:(row)=>{
                    return row?.date == null ? "No Address" : new Date(row?.date).toLocaleDateString()
                },
                size:120,
