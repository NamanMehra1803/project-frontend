...
export default function Product() {
    ...
    const productview = async () => {
        try {
            const response = await axios.post('https://my-backend-api-usbu.onrender.com/view-product');
    ...
    const categoryView = async () => {
        try {
            const response = await axios.post('https://my-backend-api-usbu.onrender.com/view-categoryes');
            if (response.data.success) {
    ...
    const handleDelete = async (product_Id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.post('https://my-backend-api-usbu.onrender.com/delete-product', { _id: product_Id });
    ...
    const searchProduct = async (e) => {
        e.preventDefault();
        try {
            const response = await axios.post("https://my-backend-api-usbu.onrender.com/product-Search", { name, cat_id });
            if (response.data.success) {
                setProducts(response.data.data);
            }
        } catch (err) {
    ...
    const handleStatusUpdate = async (pro_Id) => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                await axios.post('https://my-backend-api-usbu.onrender.com/product-status', { _id: pro_Id });
