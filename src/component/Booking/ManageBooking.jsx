...
function ManageBooking() {
    ...
    const handlePagination = (pagination) => {
        setIsLoading(true)
        Axios.get(`admin/get-manage-booking-list?page=${pagination?.pageIndex + 1}&limit=${pagination?.pageSize}&searchTerm=${serach}`).then((res) => {
            if (res.data.status) {
    ...
    //         id: id
    //     }
    //     Axios.post("admin/delete-manage-booking-list", data).then((res) => {
                            ...
                            <div className="py-3 py-lg-4">
                                <div className="row">
                                    <div className="col-lg-6">
                                        <h4 className="page-title mb-0"> Manage Booking</h4>
                                    </div>
                                </div>
                            </div>
